 ...
 */
final class Version20230424095707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commerce (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL)');
        ...
        , password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, siren VARCHAR(255) DEFAULT NULL, approved BOOLEAN DEFAULT NULL, loyalty_points INTEGER DEFAULT NULL, CONSTRAINT FK_8D93D649B09114B7 FOREIGN KEY (commerce_id) REFERENCES commerce (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
